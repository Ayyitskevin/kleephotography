...
router = APIRouter(prefix="/admin/reference", dependencies=[Depends(security.require_admin)])
...
PLAYBOOK_STAGES = [
    {
        ...
        "voice": "Love that you reached out — what are you hoping these photos do for you?",
    },
    {
        "stage": "Consultation Call",
        "dot": "#2a5db0",
        "note": "A 20-minute call to scope the shoot. Walk the menu, the room, "
        "and the deadline. Listen for the hero dishes.",
        "voice": "Tell me about the dishes you’re proudest of — those are the ones we lead with.",
    },
    {
        "stage": "Proposal Sent",
        "dot": "#9a7a2c",
        ...
        "voice": "For a menu this size I’d suggest a half-day — here’s exactly what you’d get.",
    },
    {
        ...
        "voice": "Here’s the agreement — sign at the bottom and you’re on the calendar.",
    },
    {
        "stage": "Retainer Paid",
        "dot": "#2f7d57",
        ...
        "voice": "Once the retainer’s in, the date is yours and we start planning.",
    },
    {
        ...
        "voice": "Send the first four whenever the chef is ready — I’ll stay out of the pass.",
    },
    {
        ...
        "voice": "Here’s your gallery — your favourites are already cropped for every platform.",
    },
    {
        "stage": "Archived",
        "dot": "#8A9183",
        ...
        "voice": "Loved working with you — I’ll reach out before your next menu change.",
    },
]
